...
| `share/wyvern/extensions.json` | `report-xhtml` extension |
| `scripts/ext/xhtml_report.py` | `--mode array` + manifest reader |
...
# Synthetic example manifest lands in h.5; use temp manifest in test fixture until then
