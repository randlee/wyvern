...
SC_PUBLISH_REF="${SC_PUBLISH_REF:-43552e4c9e6d3435ed58a4a7eca42dd82f7edb74}"
SC_PUBLISH_EXPECTED_SHA="${SC_PUBLISH_EXPECTED_SHA:-43552e4c9e6d3435ed58a4a7eca42dd82f7edb74}"
